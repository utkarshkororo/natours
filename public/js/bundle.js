...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaHVubnlrb3Jvcm8iLCJhIjoiY2tiNnFmZXUyMDE2NjJyb2FjNjlzMTJjbyJ9.ywfzuncTBLaA4L63N-YDDA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/hunnykororo/ckb6rdhff3qcj1jqoj8kqkuop',
    scrollZoom: false
  });
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51GsrIQHQ3tPdkdvk7w1IHppLaDvZhPt7eTa4D0GDNjcTnCSVCSds9j3U2Tva3531w1wCdX42AcbfsXXI9lHmRNwx00UmVmvtrr');
            _context.prev = 1;
            _context.next = 4;
